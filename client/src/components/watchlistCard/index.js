...
const WatchlistCard = ({ movie, onDelete, onMarkWatched }) => {
    ...
    return (
        <Card className="mb-3 movie-card">
            ...
            <Card.Body>
                ...
                <Button variant="success" onClick={() => onMarkWatched(movieId)}>Watched</Button>
                <Button variant="danger" onClick={() => onDelete(movieId)} className='ms-3'>Delete</Button>
            </Card.Body>
        </Card>
    );
};
